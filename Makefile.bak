# Eaquel_Sentinel - Makefile (Sadece hata veren kısımlar düzeltildi)
...
# HATA DÜZELTİLDİ: scripts/sign.py kaldırıldı
MODULE_INPUTS = $(shell find module/src -type f | sort)
...
$(MODULE_DONE): $(LOADER_DONE) $(ZYGISKD_DONE) $(MODULE_INPUTS)
	...
	# HATA DÜZELTİLDİ: Signing kodu tamamen kaldırıldı
